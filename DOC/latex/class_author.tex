...
\begin{DoxyParams}{Parameters}
{\em value} & Number books to add/substract from the implicit author \\
\hline
\end{DoxyParams}
\begin{DoxyPrecond}{Precondition}
An implicit \hyperlink{class_author}{Author} 
\end{DoxyPrecond}
\begin{DoxyPostcond}{Postcondition}
Updates total\+Books on the implicit author by increasing by \char`\"{}value\char`\"{} 
\end{DoxyPostcond}
...
\end{DoxyPrecond}
\begin{DoxyPostcond}{Postcondition}
Updates total\+Lines on the implicit author by increasing by \char`\"{}value\char`\"{} 
\end{DoxyPostcond}
...
\end{DoxyPrecond}
\begin{DoxyPostcond}{Postcondition}
Updates total\+Words on the implicit author by increasing by \char`\"{}value\char`\"{} 
\end{DoxyPostcond}
...
Returns total\+Books of the implicit author 
\end{DoxyReturn}
...
\end{DoxyPostcond}
\begin{DoxyReturn}{Returns}
Returns total\+Lines of the implicit author 
\end{DoxyReturn}
...
Delivers the quotes of the implicit author. 
