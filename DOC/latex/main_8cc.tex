...
65             \textcolor{comment}{// TODO: Substring refernce from input}
...
82             \textcolor{comment}{// TODO}
83         \} \textcolor{keywordflow}{else} \textcolor{keywordflow}{if} (input.substr(0, \hyperlink{main_8cc_aa0dbdd0e7744fe37a953d689ed902adb}{QUERY\_CURRENT\_WORDS}.length()) == 
      \hyperlink{main_8cc_aa0dbdd0e7744fe37a953d689ed902adb}{QUERY\_CURRENT\_WORDS}) \{
84             \textcolor{comment}{// TODO}
85         \} \textcolor{keywordflow}{else} \textcolor{keywordflow}{if} (input.substr(0, \hyperlink{main_8cc_af3ba25cc9f066f3cef24711ef73d6a53}{QUERY\_CURRENT\_FREQUENCY}.length()) == 
      \hyperlink{main_8cc_af3ba25cc9f066f3cef24711ef73d6a53}{QUERY\_CURRENT\_FREQUENCY}) \{
86             \textcolor{comment}{// TODO}
87         \} \textcolor{keywordflow}{else} \textcolor{keywordflow}{if} (input.substr(0, \hyperlink{main_8cc_a609fa4997165643203e0cb255ca772c6}{QUERY\_CURRENT\_QUOTES}.length()) == 
      \hyperlink{main_8cc_a609fa4997165643203e0cb255ca772c6}{QUERY\_CURRENT\_QUOTES}) \{
88             \textcolor{comment}{// TODO}
89         \} \textcolor{keywordflow}{else} \textcolor{keywordflow}{if} (input.substr(0, \hyperlink{main_8cc_ae38061f0fadacde833c2da1403793f06}{QUERY\_QUOTES\_ALL}.length()) == 
      \hyperlink{main_8cc_ae38061f0fadacde833c2da1403793f06}{QUERY\_QUOTES\_ALL}) \{
90             library.\hyperlink{class_library_a819acb04f4b8aea0547db50918b1c5fa}{printQuotes}();
91         \} \textcolor{keywordflow}{else} \textcolor{keywordflow}{if} (input.substr(0, \hyperlink{main_8cc_abcd8e2524f8645d5d6c12e0062838147}{QUERY\_QUOTES\_BY\_AUTHOR}.length()) == 
      \hyperlink{main_8cc_abcd8e2524f8645d5d6c12e0062838147}{QUERY\_QUOTES\_BY\_AUTHOR}) \{
92             \textcolor{keywordtype}{string} author;
93             \textcolor{comment}{// TODO: Substring author from input}
94             library.\hyperlink{class_library_aa13544bfe57c61164d9953518e88dcb0}{printQuotesByAuthor}(author);
95         \} \textcolor{keywordflow}{else} \textcolor{keywordflow}{if} (input.substr(0, \hyperlink{main_8cc_a29278b52bf17327ade47b5ea1cb41899}{QUERY\_QUOTE\_INFO}.length()) == 
      \hyperlink{main_8cc_a29278b52bf17327ade47b5ea1cb41899}{QUERY\_QUOTE\_INFO}) \{
96             \textcolor{keywordtype}{string} reference;
97             \textcolor{comment}{// TODO: Substring reference from input}
98             library.\hyperlink{class_library_aba57d7dcf92c9da4c3d8a359ceba7e2b}{getQuote}(reference).\hyperlink{class_quote_afdfb9eeaf4f528a5a5b8aee3e9dc47f4}{printQuoteInformation}();
99         \} \textcolor{keywordflow}{else} \textcolor{keywordflow}{if} (input.substr(0, \hyperlink{main_8cc_a84f0d54b44b855b01f75732c6fa1bc4b}{QUIT}.length()) == \hyperlink{main_8cc_a84f0d54b44b855b01f75732c6fa1bc4b}{QUIT}) \{
100             \textcolor{comment}{// TODO}
101         \}
102     \}
103 \}
\end{DoxyCode}
...
\begin{DoxyCode}
106            \{
107     \hyperlink{class_library}{Library} mainLibrary;
108     \hyperlink{main_8cc_ac08d8a3d49c58bde936b980d1f69ce52}{readActions}(mainLibrary);
109 \}\end{DoxyCode}
